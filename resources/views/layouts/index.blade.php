...
<body>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table table-striped text-center">
                                    ...
                                    <tbody>
                                        @foreach ($popularCustomer ?? [] as $customer)
                                        <tr height="60px">
                                            <td>{{ $customer->name }}</td>
    ...
    <script>
        ...
        var yValues = <?php echo $salesChart??0; ?>;
    ...
    <script>
        ...
        var yValues2 = <?php echo $expensesChart ??0; ?>;
