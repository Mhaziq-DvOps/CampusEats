                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="col-lg-6 col-md-4 col-sm-6">
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">Shop Description:</label>
                                                <input class="form-control" type="text" name="S_Desc">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-4 col-sm-6">
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">Shop Terms:</label>
                                                <input class="form-control" type="text" name="S_TermCond">
                                                <input type="hidden" class="form-control" name="S_Ban" value="0">
                                                <input type="hidden" class="form-control" name="S_Reason" value="null">
                                            </div>
                                        </div>
                                    </div>
                                </div>
