                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Manage Food Shop</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="row"><div class="col"><h4 class="header-title">Pending Partners</h4></div>
                                </div>
                                    ...
                                    <table id="dataTable" class="text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>List</td>
                                                <td>{{$shop->S_Name ?? 'N/A'}}</td>
                                                <td>{{$shop->created_at ??  'N/A' }}</td>
                                                <td>
