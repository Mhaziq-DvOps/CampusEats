...
if ($('#amlinechart1').length) {
    var chart = AmCharts.makeChart("amlinechart1", {
        ...
        "trendLines": [{
            "finalDate": "2019-01-11 12",
            "finalValue": 19,
            "initialDate": "2019-01-02 12",
            "initialValue": 10,
            "lineColor": "#6e00ff"
        }, {
            "finalDate": "2019-01-22 12",
            "finalValue": 10,
            "initialDate": "2019-01-17 12",
            "initialValue": 16,
            "lineColor": "#6e00ff"
        }],
        "chartScrollbar": {
    ...
    function zoomChart() {
        chart.zoomToDates(new Date(2019, 0, 2), new Date(2019, 0, 13));
    }
}
...
if ($('#amlinechart5').length) {
    ...
    function zoomChart() {
        chart.zoomToDates(new Date(2019, 2, 2), new Date(2019, 2, 10));
    }
}
